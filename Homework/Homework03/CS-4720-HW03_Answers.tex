...
\begin{center}
	...
	Figure 3.3.2
\end{center}
Therefore the overall graph is unbalanced.  Thus, we have shown that the node D can not be added to the graph with any kind of positive or negative connection that would make the overall graph a balanced complete graph.   \\
	\item PART B
\begin{center}
	\includegraphics[scale=1]{Figure_3_3_3}\\
	Figure 3.3.3
\end{center}
\begin{center}
	\includegraphics[scale=1]{Figure_3_3_4}\\
	Figure 3.3.4
\end{center}
	\item PART C
\end{enumerate}}
